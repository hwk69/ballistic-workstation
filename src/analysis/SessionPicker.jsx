...
export default function SessionPicker({ slots, setSlots, log, vars }) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap mb-4">
      ...
      <div ref={dropdownRef} className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute top-full left-0 mt-1 z-50 bg-card border border-border rounded-lg shadow-xl p-2 min-w-[260px] max-h-[320px] flex flex-col">
            <input
              value={search}
